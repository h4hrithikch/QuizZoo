...
@WebServlet("/UserArticleList.jsp")
public class AllUserArticle extends HttpServlet 
{
	...
	public void doGet(HttpServletRequest req,HttpServletResponse res) throws IOException, ServletException
	{
		...
		try 
		{
			...
			out.println("<h2 align="  +  "\""  +   "center"+ "\""+">Articles_Detail</h2><br>");
                        out.println("<h2 align="  +  "\""  +   "center"+ "\""+">Click on Article_Title to Attempt the Quiz</h2>");
			...
			while(rs.next())
			{
				...
				out.println("<td><a href='"+"Quiz.jsp?article_id="+id+"'>"+ title +"</a></td>");
